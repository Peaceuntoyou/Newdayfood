...
function Amalas({close}) {
  ...
  return (
    ...
    <img src={amala} alt="/" className='w-[80px] h-[60px]' />
    <div className='flex flex-col'>
        <h2 className='font-bold mb-2'>Amala </h2>
        <p className='text-blue-700'> ₦3000</p>
    </div>
    </div>
