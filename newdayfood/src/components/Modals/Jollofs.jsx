...
function Jollofs({closea}) {
  ...
  return (
    ...
    <img src={jollof} alt="/" className='w-[80px] h-[60px]' />
    <div className='flex flex-col'>
        <h2 className='font-bold mb-2'>Jollof</h2>
        <p className='text-blue-700'> ₦4000</p>
    </div>
    </div>
    ...
    <div className='flex flex-col items-center w-[100%] mt-10'>
        ...
        <a href="#" onClick={closeModel}>Exit</a>
    </div>
    </div>
    </div>
    </>
